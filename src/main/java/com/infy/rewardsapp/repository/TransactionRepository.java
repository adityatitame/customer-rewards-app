 ...
 *
 * <p>
 * Extends {@link CrudRepository} to provide standard CRUD operations. Also
 * defines custom query methods for retrieving transactions by customer and date
 * range.
 */
public interface TransactionRepository extends CrudRepository<Transaction, Integer> {
	...
	/**
	 * Retrieves transactions for a given customer that occurred within a specific
	 * date range.
	 *
	 * @param customerId the ID of the customer
	 * @param from       the start date (inclusive)
	 * @param to         the end date (inclusive)
	 * @return a list of transactions for the customer within the specified date
	 *         range
	 */
