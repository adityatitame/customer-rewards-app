 ...
 * 
 * <p>This aspect intercepts all methods in classes under the
 * <code>com.infy.rewardsapp.service</code> package ending with <code>*Impl</code>
 * and logs any {@link RewardsAppException} thrown by them.
 */
@Aspect
@Component
public class LoggingAspect {
	 ...
	 *
	 * <p>This advice runs after any method in a service implementation throws a
	 * {@link RewardsAppException}. It logs the error message and stack trace using Log4j2.
	 *
